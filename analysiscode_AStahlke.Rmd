...
## Make soil variables from soils NMDS
...
cl_redux1_glmer_pruned<-glmer(Clone ~ 
           ...
           +(1|cl_global_glm_pruned4$Site),
           data=cl_global_glm_pruned4, 
           family="binomial", 
           na.action = "na.fail",
           weights = rep(13,dim(gen_env_pruned)[1]))
...
cl_redux3_glmer_pruned <- glmer(Clone ~ 
            ...
            na.action = "na.fail",
             weights = rep(13,dim(gen_env_pruned)[1]))
summary(cl_redux4_glmer_pruned)
...
anova(cl_redux2_glmer_pruned, cl_redux3interaction_glmer_pruned)
```
