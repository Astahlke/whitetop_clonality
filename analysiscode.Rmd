...
importance(dd2_4)#)
# importance(subset(dd2_4, delta<=2))
...
dd2<-dredge(cl_redux2_nutrs_glmer_pruned_rescale)
subset(dd2,delta<4)
importance(dd2)#)
...
anova(stem_global_lmer_pruned_rescaled, stem_global)
